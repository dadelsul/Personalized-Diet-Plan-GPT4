...
# Initialize OpenAI client (use your own key when running locally)
...
# from openai import OpenAI
# 
# # Initialize OpenAI client (safe, with placeholder key)
# client = OpenAI(api_key=os.environ.get("OPENAI_API_KEY", "YOUR_API_KEY"))
# 
# # Fine-Tuned Model ID
# fine_tuned_model = "ft:gpt-4o-mini-2024-07-18:meead-sultan::BN4X6bXE"
...
#     "💬 Enter patient details (e.g., Create a diet plan for a 30-year-old male with diabetes)"
# )
# 
...
#             diet_plan_text.markdown(full_text)
...
validation_path = "/content/diet_validation.jsonl"
prompts = []
references = []
...
test_path = "/content/diet_test_10_ground.jsonl"
promptsTest = []
referencesTest = []
